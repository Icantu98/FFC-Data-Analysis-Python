...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = df.groupby(['sex']).get_group('Male').mean()['age']
    ...
    higher_education = round(high/total*100,1)
    lower_education = round(low/total*100,1)
    ...
    rich_perc = df['native-country'][f2].value_counts()/all_people
